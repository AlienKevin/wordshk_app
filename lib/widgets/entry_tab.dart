...
class EntryTab extends StatelessWidget {
  ...
  const EntryTab(
      {Key? key, required this.entry, required this.script, required this.variantTextStyle, required this.prTextStyle, required this.lineTextStyle, required this.linkColor, required this.rubyFontSize, required this.onTapLink, required this.scrollController, required this.player})
      : super(key: key);
