                                    ...
                                    list.visitChildren((child) {
                                      ...
                                      final displayingChild = resultModel
                                          ...
                                          .firstWhereOrNull((displayingChild) =>
                                              displayingChild.renderObject ==
                                              child);
                                      items.add((
                                        child: child,
                                        displayingChild: displayingChild
                                      ));
                                    });
                                    ...
                                    final targetEntryIndex = groupBy(
                                        ...
                                        .map((defIndex, items) {
                                          ...
                                          final entryTotalHeight = items
                                              .map((item) =>
                                                  item.child.size.height)
                                              .reduce(
                                                  (entryHeight, defHeight) =>
                                                      entryHeight + defHeight);
                                          return MapEntry(
                                              defIndex,
                                              entryDisplayingHeight /
                                                  entryTotalHeight);
                                        })
                                        .entries
                                        .fold(
                                  ...
                                  child: SelectionTransformer.separated(
                                      ...
                                      child: ListView.separated(
                                        ...
                                        separatorBuilder: (context, index) =>
                                            SizedBox(
                                          height:
                                              defIndexRanges.firstWhereOrNull(
                                                          (range) =>
                                                              range.$2 - 1 ==
                                                              index) !=
                                                      null
                          ...
                          child: TabBar(
                            ...
                            onTap: (newIndex) async {
                              if (newIndex != entryIndex) {
                                ...
                                final targetDefIndex =
                                    getStartDefIndex(newIndex);
                                await _observerController.animateTo(
                                  index: targetDefIndex,
                                  duration: const Duration(milliseconds: 500),
                                  curve: Curves.easeIn,
