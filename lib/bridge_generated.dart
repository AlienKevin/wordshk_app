...
class WordshkApiImpl implements WordshkApi {
  ...
  Future<List<EntrySummary>> getEntrySummaries(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_get_entry_summaries(port_, arg0, arg1),
...
// Section: wire2api
  ...
  EntrySummary _wire2api_entry_summary(dynamic raw) {
    ...
    return EntrySummary(
      ...
      defs: _wire2api_list___record__String_String(arr[1]),
    );
  }
...
class WordshkApiWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_get_entry_summaries = _wire_get_entry_summariesPtr
      .asFunction<void Function(int, ffi.Pointer<wire_uint_32_list>, int)>();
