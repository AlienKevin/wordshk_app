...
abstract class RustLibApiImplPlatform extends BaseApiImpl<RustLibWire> {
  ...
  @protected
  ffi.Pointer<wire_cst_list_entry_def> cst_encode_list_entry_def(
      List<EntryDef> raw) {
    final ans = wire.cst_new_list_entry_def(raw.length);
    for (var i = 0; i < raw.length; ++i) {
      cst_api_fill_to_wire_entry_def(raw[i], ans.ref.ptr[i]);
    }
    return ans;
  }
  ...
  void cst_api_fill_to_wire_combined_search_results(
    ...
    cst_api_fill_to_wire_record_opt_box_autoadd_usize_list_variant_search_result(
        apiObj.variantResults, wireObj.variant_results);
    cst_api_fill_to_wire_record_opt_box_autoadd_usize_list_pr_search_result(
  ...
  @protected
  void cst_api_fill_to_wire_entry_def(
      EntryDef apiObj, wire_cst_entry_def wireObj) {
    wireObj.yue_trad = cst_encode_String(apiObj.yueTrad);
    wireObj.yue_simp = cst_encode_String(apiObj.yueSimp);
  ...
  void cst_api_fill_to_wire_entry_summary(
    ...
    wireObj.variant_trad = cst_encode_String(apiObj.variantTrad);
    wireObj.variant_simp = cst_encode_String(apiObj.variantSimp);
    wireObj.defs = cst_encode_list_entry_def(apiObj.defs);
  }
  ...
  void
      cst_api_fill_to_wire_record_opt_box_autoadd_usize_list_english_search_result(
          (int?, List<EnglishSearchResult>) apiObj,
          wire_cst_record_opt_box_autoadd_usize_list_english_search_result
              wireObj) {
    wireObj.field0 = cst_encode_opt_box_autoadd_usize(apiObj.$1);
    wireObj.field1 = cst_encode_list_english_search_result(apiObj.$2);
  }

  @protected
  void cst_api_fill_to_wire_record_opt_box_autoadd_usize_list_pr_search_result(
      (int?, List<PrSearchResult>) apiObj,
      wire_cst_record_opt_box_autoadd_usize_list_pr_search_result wireObj) {
    wireObj.field0 = cst_encode_opt_box_autoadd_usize(apiObj.$1);
    wireObj.field1 = cst_encode_list_pr_search_result(apiObj.$2);
  }

  @protected
  void
      cst_api_fill_to_wire_record_opt_box_autoadd_usize_list_variant_search_result(
          (int?, List<VariantSearchResult>) apiObj,
          wire_cst_record_opt_box_autoadd_usize_list_variant_search_result
              wireObj) {
    wireObj.field0 = cst_encode_opt_box_autoadd_usize(apiObj.$1);
    wireObj.field1 = cst_encode_list_variant_search_result(apiObj.$2);
  }
...
class RustLibWire implements BaseWire {
  ...
  late final _wire_get_entry_summariesPtr = _lookup<
      ...
      'frbgen_wordshk_wire_get_entry_summaries');
  ...
  void wire_init_api(
    ...
    ffi.Pointer<wire_cst_list_prim_u_8> dict_zip,
  ) {
  ...
  late final _cst_new_box_autoadd_usizePtr = _lookup<
      ...
      'frbgen_wordshk_cst_new_box_autoadd_usize');
  ...
  ffi.Pointer<wire_cst_list_entry_def> cst_new_list_entry_def(
    int len,
  ) {
    return _cst_new_list_entry_def(
      len,
    );
  }

  late final _cst_new_list_entry_defPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<wire_cst_list_entry_def> Function(
              ffi.Int32)>>('frbgen_wordshk_cst_new_list_entry_def');
  late final _cst_new_list_entry_def = _cst_new_list_entry_defPtr
      .asFunction<ffi.Pointer<wire_cst_list_entry_def> Function(int)>();
...
final class wire_cst_entry_def extends ffi.Struct {
  external ffi.Pointer<wire_cst_list_prim_u_8> yue_trad;

  external ffi.Pointer<wire_cst_list_prim_u_8> yue_simp;

  external ffi.Pointer<wire_cst_list_prim_u_8> eng;
}

final class wire_cst_list_entry_def extends ffi.Struct {
  external ffi.Pointer<wire_cst_entry_def> ptr;
...
final class wire_cst_entry_summary extends ffi.Struct {
  external ffi.Pointer<wire_cst_list_prim_u_8> variant_trad;

  external ffi.Pointer<wire_cst_list_prim_u_8> variant_simp;

  external ffi.Pointer<wire_cst_list_entry_def> defs;
}
...
final class wire_cst_record_opt_box_autoadd_usize_list_variant_search_result
    extends ffi.Struct {
  external ffi.Pointer<ffi.UintPtr> field0;

  external ffi.Pointer<wire_cst_list_variant_search_result> field1;
}

final class wire_cst_record_opt_box_autoadd_usize_list_pr_search_result
    extends ffi.Struct {
  external ffi.Pointer<ffi.UintPtr> field0;

  external ffi.Pointer<wire_cst_list_pr_search_result> field1;
}

final class wire_cst_record_opt_box_autoadd_usize_list_english_search_result
    extends ffi.Struct {
  external ffi.Pointer<ffi.UintPtr> field0;

  external ffi.Pointer<wire_cst_list_english_search_result> field1;
}

final class wire_cst_combined_search_results extends ffi.Struct {
  external wire_cst_record_opt_box_autoadd_usize_list_variant_search_result
      variant_results;

  external wire_cst_record_opt_box_autoadd_usize_list_pr_search_result
      pr_results;

  external wire_cst_record_opt_box_autoadd_usize_list_english_search_result
      english_results;
}
