    ...
    _indexingTimer = Timer(const Duration(seconds: indexingDelay), () async {
      ...
      scaffoldMessengerKey.currentState?.showSnackBar(SnackBar(
          content: Text(switch (language) {
            ...
            Language.yue =>
              '小提示：我哋喺度更新緊Spotlight資料，個app喺接落嚟嘅幾分鐘內可能會lag機。多謝你嘅耐心等候。',
            Language.zhHant =>
              '小提示：我們正在更新Spotlight資料，APP在接下來的幾分鐘内可能會有卡頓。感謝您的耐心等待。',
            Language.zhHans =>
              '小提示：我们正在更新Spotlight数据，APP在接下来的两分钟内可能会有卡顿。感谢您的耐心等待。',
          }),
