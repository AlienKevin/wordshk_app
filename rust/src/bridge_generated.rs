...
fn wire_new__static_method__Api_impl(
    port_: MessagePort,
    api_json: impl Wire2Api<String> + UnwindSafe,
    english_index_json: impl Wire2Api<String> + UnwindSafe,
    word_list: impl Wire2Api<String> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "new__static_method__Api",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
...
fn wire_pr_search__method__Api_impl(
    port_: MessagePort,
    that: impl Wire2Api<Api> + UnwindSafe,
    capacity: impl Wire2Api<u32> + UnwindSafe,
    query: impl Wire2Api<String> + UnwindSafe,
    script: impl Wire2Api<Script> + UnwindSafe,
    romanization: impl Wire2Api<Romanization> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "pr_search__method__Api",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
...
fn wire_variant_search__method__Api_impl(
    port_: MessagePort,
    that: impl Wire2Api<Api> + UnwindSafe,
    capacity: impl Wire2Api<u32> + UnwindSafe,
    query: impl Wire2Api<String> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "variant_search__method__Api",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
...
fn wire_combined_search__method__Api_impl(
    port_: MessagePort,
    that: impl Wire2Api<Api> + UnwindSafe,
    capacity: impl Wire2Api<u32> + UnwindSafe,
    query: impl Wire2Api<String> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "combined_search__method__Api",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
...
fn wire_english_search__method__Api_impl(
    port_: MessagePort,
    that: impl Wire2Api<Api> + UnwindSafe,
    capacity: impl Wire2Api<u32> + UnwindSafe,
    query: impl Wire2Api<String> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "english_search__method__Api",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
...
fn wire_get_entry_json__method__Api_impl(
    port_: MessagePort,
    that: impl Wire2Api<Api> + UnwindSafe,
    id: impl Wire2Api<usize> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "get_entry_json__method__Api",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_that = that.wire2api();
            let api_id = id.wire2api();
            move |task_callback| Ok(Api::get_entry_json(&api_that, api_id))
        },
    )
}
fn wire_get_entry_group_json__method__Api_impl(
    port_: MessagePort,
    that: impl Wire2Api<Api> + UnwindSafe,
    id: impl Wire2Api<usize> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "get_entry_group_json__method__Api",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_that = that.wire2api();
            let api_id = id.wire2api();
            move |task_callback| Ok(Api::get_entry_group_json(&api_that, api_id))
        },
    )
}
fn wire_get_entry_id__method__Api_impl(
    port_: MessagePort,
    that: impl Wire2Api<Api> + UnwindSafe,
    query: impl Wire2Api<String> + UnwindSafe,
    script: impl Wire2Api<Script> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "get_entry_id__method__Api",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            ...
            let api_query = query.wire2api();
            let api_script = script.wire2api();
            move |task_callback| Ok(Api::get_entry_id(&api_that, api_query, api_script))
        },
    )
}
fn wire_get_jyutping__method__Api_impl(
    port_: MessagePort,
    that: impl Wire2Api<Api> + UnwindSafe,
    query: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "get_jyutping__method__Api",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_that = that.wire2api();
            let api_query = query.wire2api();
            move |task_callback| Ok(Api::get_jyutping(&api_that, api_query))
        },
    )
}
...
impl support::IntoDart for Api {
    fn into_dart(self) -> support::DartAbi {
        vec![
            self.dict.into_dart(),
            self.english_index.into_dart(),
            self.variants_map.into_dart(),
            self.word_list.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for Api {}
