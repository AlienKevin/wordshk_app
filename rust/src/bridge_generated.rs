...
fn wire_pr_search_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<PrSearchResult>, _>(
        WrapInfo {
...
fn wire_variant_search_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<VariantSearchResult>, _>(
        WrapInfo {
...
fn wire_combined_search_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, CombinedSearchResults, _>(
        WrapInfo {
...
fn wire_english_search_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<EnglishSearchResult>, _>(
        WrapInfo {
...
fn wire_eg_search_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, (Option<String>, Vec<EgSearchResult>), _>(
        WrapInfo {
...
fn wire_get_entry_id_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Option<u32>, _>(
        ...
        move || {
            let api_query = query.wire2api();
            let api_script = script.wire2api();
            move |task_callback| Result::<_, ()>::Ok(get_entry_id(api_query, api_script))
        },
    )
}
