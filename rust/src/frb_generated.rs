...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1434388931;
...
fn wire__crate__api__api__get_entry_json_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(crate::api::api::get_entry_json(api_id))?;
                    Ok(output_ok)
                })())
            }
        },
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        6 => wire__crate__api__api__get_entry_json_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__api__get_entry_summaries_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__api__init_api_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__api__init_utils_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
